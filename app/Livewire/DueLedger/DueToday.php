...
class DueToday extends Component
{
    ...
    // Additional Modal visibilities (same as all-due-list)
    ...
    public function edit($id)
    {
        ...
        $this->total_due = Challan::where(function ($q) use ($challan) {
    ...
    public function save()
    {
        ...
        $this->dispatch('show-toast', message: 'চালান তথ্য সফলভাবে আপডেট করা হয়েছে।', type: 'success');
        $this->closeModal();
    }
    ...
    public function delete($id)
    {
        ...
        $this->dispatch('show-toast', message: 'চালান সফলভাবে মুছে ফেলা হয়েছে।', type: 'success');
    }
