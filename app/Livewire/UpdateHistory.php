    ...
    public function mount()
    {
        if (ActivityLog::count() === 0) {
            $mockLogs = [
                ...
                ['field' => 'আনলোড আপডেট', 'description' => 'শ্রেণি পিকেট। পূর্বের আনলোডের পরিমাণঃ ৫০০। নতুন আনলোডের পরিমাণঃ ১৫০০', 'created_at' => now()->subDays(20)],
                ...
                ['field' => 'আনলোড আপডেট', 'description' => 'শ্রেণি পিকেট। পূর্বের আনলোডের পরিমাণঃ ৮০০। নতুন আনলোডের পরিমাণঃ ১,০০০', 'created_at' => now()->subDays(8)],
