        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
            ...
            <div class="relative flex items-center">
                <input type="text"
                       ...
                       placeholder="তারিখ"
                       readonly
                       class="pl-3 pr-8 py-2 text-xs rounded-xl border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-950 text-gray-800 dark:text-white focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all w-44 font-sans font-semibold cursor-pointer">
            ...
            <button type="button" wire:click="openAddModal"
                    class="px-4 py-2 bg-primary hover:bg-primary-dark text-white text-xs font-bold rounded-xl cursor-pointer transition-all shadow-md active:scale-95 font-sans">
                নতুন চালান
            </button>
        </div>
    </div>
...
@endif
    ...
    <template x-teleport="body">
        <div id="today-challan-print-area" class="hidden">
            ...
            <div id="today-challan-print-area" class="print-page">
                <!-- Company Header -->
