        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 flex-wrap">
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="relative flex items-center">
                    <input type="text"
                           ...
                           readonly
                           class="pl-3 pr-8 py-2 text-xs rounded-xl border border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-950 text-gray-800 dark:text-white focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/10 transition-all w-36 font-sans font-semibold cursor-pointer">
            ...
            <div class="grid grid-cols-2 gap-2 w-full sm:flex sm:items-center sm:gap-3 sm:w-auto">
                ...
                <button type="button" onclick="printChallanArea('all-challan-print-area')"
                        class="px-3 py-2 bg-gray-100 dark:bg-slate-800 hover:bg-gray-200 dark:hover:bg-slate-700 text-gray-700 dark:text-slate-200 text-xs font-semibold rounded-xl cursor-pointer transition-all font-sans border border-gray-200 dark:border-slate-700 flex items-center justify-center gap-1.5 w-full sm:w-auto">
                ...
                <table class="w-full text-left border-collapse border border-gray-200 dark:border-slate-800" style="min-width: 1100px">
                    <thead>
                        <tr class="bg-primary text-white text-[11px] font-bold uppercase font-sans select-none">
                            ...
                            <th wire:click="sortBy('date')" class="px-3 py-3 border-r border-white/20 last:border-r-0 cursor-pointer hover:bg-primary-dark transition-colors">
                            ...
                            <th wire:click="sortBy('customer_name')" class="px-3 py-3 border-r border-white/20 last:border-r-0 cursor-pointer hover:bg-primary-dark transition-colors">
                            ...
                            <th wire:click="sortBy('grand_total')" class="px-3 py-3 text-right border-r border-white/20 last:border-r-0 cursor-pointer hover:bg-primary-dark transition-colors">
                            ...
                            <th wire:click="sortBy('cash')" class="px-3 py-3 text-right border-r border-white/20 last:border-r-0 cursor-pointer hover:bg-primary-dark transition-colors">
                                <div class="flex items-center justify-end gap-1">
                                    <span>নগদ</span>
                                    @if ($sortField === 'cash')
                                        <span class="text-[9px]">{{ $sortDirection === 'asc' ? '▲' : '▼' }}</span>
                            ...
                            <th wire:click="sortBy('due')" class="px-3 py-3 text-right border-r border-white/20 last:border-r-0 cursor-pointer hover:bg-primary-dark transition-colors">
                                <div class="flex items-center justify-end gap-1">
                                    <span>বাকি</span>
                                    @if ($sortField === 'due')
                                        <span class="text-[9px]">{{ $sortDirection === 'asc' ? '▲' : '▼' }}</span>
                                            ...
                                            <template x-teleport="body">
                                                <div x-show="openTooltip" 
                                                    ...
                                                    <h4 class="text-gray-800 dark:text-white border-b border-gray-100 dark:border-slate-800 pb-1.5 mb-1.5 font-bold flex items-center gap-1.5">
                                                        <svg class="w-3.5 h-3.5 text-primary" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                                        ডেলিভারি তথ্য
                                                    </h4>
                                                    <div class="space-y-1">
                                ...
                                <td class="px-3 py-3.5 text-center relative" x-data="{ openDropdown: false, buttonRect: null }">
                                    ...
                                    <template x-teleport="body">
                                        <div x-show="openDropdown" @click.away="openDropdown = false" x-transition
                                             ...
                                             x-cloak>
                                        <button type="button" @click="openDropdown = false" class="w-full text-left px-3 py-2 hover:bg-primary-50 dark:hover:bg-primary-950/20 text-gray-700 dark:text-slate-200 hover:text-primary-dark dark:hover:text-primary-400 transition-all font-semibold rounded-xl cursor-pointer flex items-center gap-2">
                    ...
                    @if($challans->count() > 0)
                    <tfoot>
                        <tr class="bg-primary/10 dark:bg-primary-950/30 border-t-2 border-primary-200 dark:border-primary-900/50 text-xs font-bold font-sans">
                            <td colspan="5" class="px-3 py-3 text-primary-dark dark:text-primary-400 border-r border-gray-200 dark:border-slate-800 last:border-r-0">মোট চালান {{ $challans->count() }} টি</td>
                            <td class="px-3 py-3 text-right text-primary-dark dark:text-primary-400 border-r border-gray-200 dark:border-slate-800 last:border-r-0">
                ...
                <div class="p-5">
                    ...
                    <div class="rounded-xl overflow-hidden border border-gray-200 dark:border-slate-700 mb-5">
                        <table class="w-full text-sm text-left">
                            <thead>
                                <tr class="bg-primary text-white text-xs font-bold uppercase">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-slate-800">
                                ...
                                @if(count($report['rows']) > 0)
                                    <tr class="bg-primary-50 dark:bg-primary-950/30 text-xs font-bold border-t-2 border-primary-200 dark:border-primary-800">
                                        <td class="px-4 py-3 text-primary-dark dark:text-primary-400 border-r border-primary-100 dark:border-primary-900">মোট</td>
                                        <td class="px-4 py-3 text-center text-primary-dark dark:text-primary-400 border-r border-primary-100 dark:border-primary-900">{{ $report['total_challans'] }}</td>
                                        <td class="px-4 py-3 text-right text-primary-dark dark:text-primary-400">{{ number_format($report['total_qty']) }}</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
    ...
    @if($showModal)
        <div x-data="{ open: true }"
            ...
            <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-4xl w-full border border-gray-200 dark:border-slate-700 shadow-2xl p-6 relative max-h-[92vh] overflow-y-auto challan-modal-scroll"
                ...
                <form wire:submit.prevent="save" class="space-y-4 max-w-3xl mx-auto">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-gray-100 dark:border-slate-800 pb-4 mb-6">
                        ...
                        <div class="flex items-center gap-2">
                            <button type="button" @click="$wire.set('customer_type', 'new')"
                                    ...
                                    :class="$wire.customer_type === 'new' ? 'bg-[#009E74] text-white shadow-sm' : 'border border-[#009E74] text-[#009E74] hover:bg-primary-50 dark:hover:bg-primary-950/20'">
                                নতুন কাস্টমার
                            </button>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="relative flex items-center">
                                <input type="text"
                                       ...
                                       placeholder="তারিখ"
                                       readonly
                                       class="pl-3 pr-8 py-1.5 text-xs rounded-lg border border-gray-250 dark:border-slate-700 bg-white dark:bg-slate-900 text-gray-808 dark:text-white focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-505/10 transition-all w-32 font-sans font-semibold cursor-pointer text-center">
                    ...
                    <div x-show="$wire.customer_type === 'old'" class="mb-4" x-cloak>
                        ...
                        <div class="relative" x-data="{ openLedger: false, triggerRect: null, searchLedger: '' }">
                            <button type="button" @click="openLedger = !openLedger; triggerRect = $el.getBoundingClientRect()"
                                    class="w-full flex items-center justify-between py-2 px-3 rounded-lg border border-gray-250 dark:border-slate-700 bg-white dark:bg-slate-900 text-xs font-semibold text-gray-808 dark:text-white focus:outline-none focus:border-primary-500 cursor-pointer text-left">
                                @php
                                    $selectedLedgerName = '';
                                    if ($ledger_id) {
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" wire:model="customer_phone" placeholder="ফোন নম্বর" maxlength="11"
                                       class="w-full py-2 px-3 rounded-lg border border-gray-250 dark:border-slate-700 bg-white dark:bg-slate-900 text-xs text-gray-808 dark:text-white focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-505/10 transition-all font-sans font-semibold pr-12">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="customer_name" placeholder="কাস্টমারের নাম" 
                                   class="w-full py-2 px-3 rounded-lg border border-gray-250 dark:border-slate-700 bg-white dark:bg-slate-900 text-xs text-gray-808 dark:text-white focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-505/10 transition-all font-sans font-semibold">
                        </div>
                        <div>
                                    ...
                                    <div x-show="openType" @click.away="openType = false" @close-cat-dropdowns.window="openType = false" x-transition
                                        ...
                                        <div class="py-1">
                                            <button type="button" @click="$wire.set('challan_type', 'আজকের'); openType = false;"
                                                    class="w-full text-left px-3.5 py-2 hover:bg-primary-50/30 dark:hover:bg-primary-950/20 text-xs font-semibold text-gray-808 dark:text-white hover:text-primary-dark dark:hover:text-primary-400 transition-all font-sans cursor-pointer block">
                                                রেগুলার চালান
                                            </button>
                            ...
                            @foreach($items as $index => $item)
                                <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-center text-xs bg-white dark:bg-slate-900 md:bg-transparent p-3 md:p-0 rounded-xl border border-gray-100 dark:border-slate-800 md:border-none">
                                    ...
                                    <div class="flex md:hidden items-center justify-between mb-1 pb-1.5 border-b border-gray-100 dark:border-slate-800">
                                        ...
                                        <div class="flex items-center gap-2">
                                            @if($loop->first)
                                                <button type="button" wire:click="addItem" class="w-7 h-7 rounded-lg bg-primary-50 hover:bg-primary-100 dark:bg-primary-950/20 text-primary dark:text-primary-400 font-bold flex items-center justify-center cursor-pointer transition-all border border-primary-200 text-base leading-none shrink-0">+</button>
                                            @else
                                    ...
                                    <div class="col-span-1 hidden md:flex justify-center items-center">
                                        @if($loop->first)
                                            <button type="button" wire:click="addItem" class="w-7 h-7 rounded-lg bg-primary-50 hover:bg-primary-100 dark:bg-primary-950/20 text-primary dark:text-primary-400 font-bold flex items-center justify-center cursor-pointer transition-all border border-primary-200">+</button>
                                        @else
