<div class="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-300">
    ...
    <div class="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 px-4 sm:px-6 py-3 rounded-lg flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 transition-colors duration-300">
        <div>
            <h2 class="font-bold text-gray-800 dark:text-white text-sm leading-tight">সব চালান</h2>
            <p class="text-[10px] text-gray-400 dark:text-gray-500 font-sans mt-0.5 font-semibold">সকল চালানের সম্পূর্ণ তালিকা ও রিপোর্ট</p>
        </div>
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 flex-wrap">
            ...
            <div class="flex items-center gap-2">
                <span class="text-[10px] font-bold text-gray-500 dark:text-gray-400 font-sans whitespace-nowrap">শুরু:</span>
                <div class="relative flex items-center">
                    <input type="text"
                           ...
                           readonly
                           class="pl-3 pr-8 py-2 text-xs rounded-xl border border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-950 text-gray-800 dark:text-white focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 transition-all w-36 font-sans font-semibold cursor-pointer">
                    <span class="absolute right-2.5 top-2 text-gray-400 pointer-events-none">
            ...
            <!-- Date Range: To -->
            <div class="flex items-center gap-2">
                <span class="text-[10px] font-bold text-gray-500 dark:text-gray-400 font-sans whitespace-nowrap">শেষ:</span>
                <div class="relative flex items-center">
                    <input type="text"
                           data-flatpickr
            ...
            <!-- Print -->
            <button type="button" onclick="printChallanArea('all-challan-print-area')"
                ...
                <table class="w-full text-left border-collapse border border-gray-200 dark:border-slate-800" style="min-width: 1100px">
                    <thead>
                        <tr class="bg-emerald-600 text-white text-[11px] font-bold uppercase font-sans">
                            ...
                            <th class="px-3 py-3 border-r border-white/20 last:border-r-0">তারিখ</th>
                            ...
                            <th class="px-3 py-3 text-right border-r border-white/20 last:border-r-0">গাড়ি ভাড়া</th>
                            ...
                            <th class="px-3 py-3 text-center border-r border-white/20 last:border-r-0">ধরন</th>
                        ...
                        @forelse($challans as $challan)
                            <tr class="hover:bg-emerald-50/40 dark:hover:bg-emerald-950/10 transition-colors text-xs">
                                ...
                                <td class="px-3 py-3.5 text-center border-r border-gray-150 dark:border-slate-800 last:border-r-0">
                                    <span class="px-2 py-0.5 rounded-full text-[10px] font-bold {{ $challan->challan_type === 'আজকের' ? 'bg-emerald-50 dark:bg-emerald-950/30 text-emerald-700 dark:text-emerald-400 border border-emerald-100' : 'bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-400 border border-amber-100' }}">
                            ...
                            <tr>
                                <td colspan="16" class="px-4 py-16 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        <p class="text-xs text-gray-400 dark:text-gray-500 italic font-sans">কোনো চালান পাওয়া যায়নি।</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
                    ...
                    <tfoot>
                        <tr class="bg-emerald-600/10 dark:bg-emerald-950/30 border-t-2 border-emerald-200 dark:border-emerald-900/50 text-xs font-bold font-sans">
                            <td colspan="5" class="px-3 py-3 text-emerald-700 dark:text-emerald-400 border-r border-gray-200 dark:border-slate-800 last:border-r-0">মোট চালান {{ $challans->count() }} টি</td>
                            ...
                            <td class="px-3 py-3 text-right text-red-650 border-r border-gray-200 dark:border-slate-800 last:border-r-0">৳{{ number_format($challans->sum('due'), 2) }}</td>
    ...
    @if($showModal)
        <div x-data="{ open: true }"
            ...
            <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-2xl w-full border border-gray-200 dark:border-slate-700 shadow-2xl p-6 relative max-h-[92vh] overflow-y-auto challan-modal-scroll"
                ...
                <h3 class="text-base font-bold text-gray-800 dark:text-white mb-5 border-b border-secondary/20 dark:border-slate-800 pb-3 font-sans flex items-center justify-center gap-2">
                ...
                <form wire:submit.prevent="save" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4" x-show="$wire.customer_type === 'new'">
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" wire:model="customer_phone" placeholder="ফোন নম্বর" maxlength="11"
                                       class="w-full py-2.5 px-3 rounded-xl border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-xs text-gray-800 dark:text-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all font-semibold">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="customer_name" placeholder="কাস্টমারের নাম" class="w-full py-2.5 px-3 rounded-xl border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-xs text-gray-800 dark:text-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all font-semibold">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1.5 font-sans">কাস্টমারের ঠিকানা</label>
                            <input type="text" wire:model="customer_address" placeholder="কাস্টমারের ঠিকানা" class="w-full py-2.5 px-3 rounded-xl border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-xs text-gray-800 dark:text-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all font-semibold">
                        </div>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4" x-show="$wire.customer_type === 'old'" x-cloak>
                        <div>
                            <label class="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1.5 font-sans">পুরাতন খতিয়ান গ্রাহক</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
                        <div>
                            <label class="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1.5 font-sans">চালানের ধরন</label>
                            <select wire:model="challan_type" class="w-full py-2.5 px-3 rounded-xl border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-xs text-gray-800 dark:text-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all font-semibold">
                                <option value="আজকের">আজকের</option>
                                <option value="অগ্রিম">অগ্রিম</option>
                            </select>
                        </div>
                        <div>
                             ...
                             <div class="relative flex items-center">
                                 <input type="text"
                                        ...
                                        readonly
                                        class="w-full py-2.5 pl-3 pr-10 rounded-xl border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-xs text-gray-800 dark:text-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all font-sans font-semibold cursor-pointer">
                                 <span class="absolute right-3 top-2.5 text-secondary pointer-events-none">
                                     <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                                 </span>
                             </div>
                        </div>
                        <div>
                            ...
                            <input type="text" wire:model="notes" placeholder="নোট..." class="w-full py-2.5 px-3 rounded-xl border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-xs text-gray-800 dark:text-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all font-semibold">
                        </div>
                    </div>
                    ...
                    <div class="mt-6 border border-gray-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm">
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-gray-55 dark:bg-slate-950 border-b border-gray-200 dark:border-slate-800 text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase font-sans">
                                    <th class="px-3 py-2.5 text-center w-12 border-r border-gray-200 dark:border-slate-800">#</th>
                                    <th class="px-3 py-2.5 border-r border-gray-200 dark:border-slate-800">শ্রেণি</th>
                                    <th class="px-3 py-2.5 text-right border-r border-gray-200 dark:border-slate-800 w-28">রেট</th>
                                    <th class="px-3 py-2.5 text-right border-r border-gray-200 dark:border-slate-800 w-28">পরিমাণ</th>
                                    <th class="px-3 py-2.5 text-right border-r border-gray-200 dark:border-slate-800 w-32">মূল্য</th>
                            ...
                            <tbody class="divide-y divide-gray-150 dark:divide-slate-800 font-sans">
                                @foreach($items as $index => $item)
                                    <tr class="text-xs">
                                        ...
                                        <td class="px-3 py-2.5 border-r border-gray-150 dark:border-slate-850 relative" x-data="{ openCat: false, triggerRect: null }">
                                                 ...
                                                 <div x-show="openCat" @click.away="openCat = false" @close-cat-dropdowns.window="openCat = false" x-transition
                                                     ...
                                                     <div class="p-2 border-b border-gray-100 dark:border-slate-800 flex gap-1.5 bg-gray-50 dark:bg-slate-950">
                                                         <input type="text" wire:model="newCategoryInput" placeholder="ফিল্টার বা নতুন শ্রেণি..."
                                                                class="flex-1 py-1 px-2 text-[10px] rounded-lg border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-gray-800 dark:text-white focus:outline-none focus:border-emerald-500 font-sans"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 items-end">
                        <div class="flex flex-col items-center justify-center p-4 bg-gray-55 dark:bg-slate-955 border border-gray-100 dark:border-slate-855 rounded-3xl gap-4">
                        ...
                        <div class="space-y-3 font-sans">
                            <div class="grid grid-cols-2 items-center gap-2">
                                ...
                                <div class="py-2 px-3 text-xs bg-gray-55 dark:bg-slate-950 border border-gray-200 dark:border-slate-850 rounded-xl text-right text-gray-808 dark:text-white font-bold select-none">৳{{ number_format($value, 2) }}</div>
                            </div>
                            <div class="grid grid-cols-2 items-center gap-2">
                                <span class="text-xs font-bold text-gray-600 dark:text-gray-400">গাড়ি ভাড়া:</span>
                            ...
                            <div class="grid grid-cols-2 items-center gap-2">
                                <span class="text-xs font-bold text-gray-600 dark:text-gray-400">ছাড়:</span>
                            ...
                            <div class="grid grid-cols-2 items-center gap-2">
                                ...
                                <div class="py-2 px-3 text-xs bg-gray-50 dark:bg-slate-950 border border-gray-200 dark:border-slate-800 rounded-xl text-right text-emerald-600 dark:text-emerald-400 font-bold select-none">৳{{ number_format($grand_total, 2) }}</div>
                            </div>
                            <div class="grid grid-cols-2 items-center gap-2">
                            ...
                            <div class="grid grid-cols-2 items-center gap-2">
                                ...
                                <div class="py-2 px-3 text-xs bg-gray-50 dark:bg-slate-950 border border-gray-200 dark:border-slate-800 rounded-xl text-right text-red-600 dark:text-red-400 font-bold select-none">৳{{ number_format($due, 2) }}</div>
                            </div>
                        </div>
                    </div>

                    <!-- Footer actions -->
                    <div class="flex items-center justify-end gap-2.5 pt-5 border-t border-gray-200 dark:border-slate-700 mt-2">
                        <button type="button" wire:click="resetForm" class="px-5 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 hover:text-white hover:bg-red-500 border border-gray-200 dark:border-slate-700 rounded-xl cursor-pointer transition-all font-sans">ক্লিয়ার</button>
                        <button type="submit" class="px-6 py-2 bg-primary hover:bg-primary/90 text-white text-xs font-bold rounded-xl cursor-pointer transition-all shadow-md active:scale-95 font-sans">সেভ করুন</button>
    ...
    <style>
        ...
        @media print {
            ...
            #all-challan-print-area,
            #all-challan-print-area * { visibility: visible !important; }
            #all-challan-print-area {
