                ...
                <table class="w-full text-left border-collapse border border-gray-200 dark:border-slate-800" style="min-width: 1100px">
                    ...
                    <tfoot>
                        <tr class="bg-primary/10 dark:bg-primary-950/30 border-t-2 border-primary-200 dark:border-primary-900/50 text-xs font-bold font-sans">
                            ...
                            <td class="px-3 py-3 text-right text-red-650 border-r border-gray-200 dark:border-slate-800 last:border-r-0">৳{{ number_format((float)($challans->sum('due')), (float)($challans->sum('due')) == (int)($challans->sum('due')) ? 0 : 2) }}</td>
...
@endif
    ...
    <template x-teleport="body">
        ...
        <div id="all-challan-print-area" class="print-page">
            <!-- Company Header -->
