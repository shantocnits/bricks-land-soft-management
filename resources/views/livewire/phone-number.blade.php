                            ...
                            <td class="py-3 px-4 text-center">
                                <div class="flex items-center justify-center gap-1.5">
                                    ...
                                    <button type="button"
                                        ...
                                        onclick="confirm('এই নম্বরটি মুছে ফেলবেন?') || event.stopImmediatePropagation()"
                ...
                <div class="p-4 space-y-2 hover:bg-emerald-50/20 dark:hover:bg-slate-800/30 transition-colors">
                    <div class="flex items-start justify-between gap-3">
                        ...
                        <div class="flex items-center gap-1.5 flex-shrink-0">
                            ...
                            <button type="button" wire:click="delete({{ $contact->id }})" onclick="confirm('মুছবেন?') || event.stopImmediatePropagation()"
