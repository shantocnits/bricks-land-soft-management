                    ...
                    <div class="flex items-center justify-between pt-2 border-t border-gray-100 dark:border-slate-800">
                        ...
                        <div class="flex items-center gap-3">
                            @if($isToday)
                                ...
                                <button type="button" wire:click="confirmDelete({{ $entry->id }})" class="text-red-500 hover:text-red-700 cursor-pointer">
    ...
    <div class="fixed inset-0 z-[999999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm"
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl max-w-sm w-full p-6 shadow-2xl border border-gray-150 dark:border-slate-800 text-center font-sans">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mb-6">
                আপনি কি নিশ্চিত যে এই আনলোড হিসাবটি মুছে ফেলতে চান?
            </p>
