        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 flex-wrap">
            ...
            <div class="grid grid-cols-2 gap-2 w-full sm:flex sm:items-center sm:gap-3 sm:w-auto">
                ...
                <div class="relative flex items-center col-span-2 sm:col-span-1">
                    ...
                    <span class="absolute right-2.5 top-2 text-emerald-500 pointer-events-none">
                ...
                <div class="flex items-center gap-2 col-span-1">
                    ...
                    <div class="relative flex items-center w-full">
                        <input type="text"
                               ...
                               readonly
                               class="pl-3 pr-8 py-2 text-xs rounded-xl border border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-950 text-gray-800 dark:text-white focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 transition-all w-full sm:w-28 font-sans font-semibold cursor-pointer">
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 gap-2 w-full sm:flex sm:items-center sm:gap-3 sm:w-auto">
                ...
                <button type="button" wire:click="openNewDeliveryModal"
                        class="col-span-2 sm:col-span-1 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl cursor-pointer transition-all shadow-md active:scale-95 font-sans w-full sm:w-auto flex items-center justify-center">
                    নতুন ডেলিভারি
                </button>
            </div>
        </div>
                    ...
                    <tbody class="text-xs font-semibold text-gray-700 dark:text-slate-350 divide-y divide-gray-100 dark:divide-slate-800">
                        @forelse ($deliveries as $index => $dl)
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition-all font-sans">
                                ...
                                <td class="px-3 py-3.5 text-right font-mono border-r border-gray-100 dark:border-slate-800 text-emerald-600 dark:text-emerald-450 font-bold">{{ number_format($dl->quantity) }}</td>
                                ...
                                <td class="px-3 py-3.5 text-center relative" x-data="{ openDropdown: false, buttonRect: null }">
                                    ...
                                    <template x-teleport="body">
                                        <div x-show="openDropdown" @click.away="openDropdown = false" x-transition
                                             ...
                                             x-cloak>
                                            <button type="button" onclick="window.print()" class="w-full text-left px-3 py-2 hover:bg-emerald-50 dark:hover:bg-emerald-950/20 text-gray-700 dark:text-slate-200 hover:text-emerald-700 dark:hover:text-emerald-400 transition-all font-semibold rounded-xl cursor-pointer flex items-center gap-2">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-4xl w-full border border-gray-255 dark:border-slate-700 shadow-2xl p-7 relative max-h-[92vh] overflow-y-auto challan-modal-scroll animate-in fade-in zoom-in-95 duration-150">
            ...
            <div class="space-y-5 text-gray-800 dark:text-slate-200">
                ...
                <div class="flex flex-col sm:flex-row justify-between gap-4">
                    <div>
                        <h4 class="font-extrabold text-emerald-600 dark:text-emerald-400 text-lg">ডেলিভারি নং: {{ $selectedDelivery->delivery_no }}</h4>
                ...
                <div class="border border-gray-150 dark:border-slate-800 rounded-2xl overflow-hidden text-xs">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-slate-800 font-semibold text-gray-700 dark:text-slate-300">
                            <tr>
                                <td class="px-4 py-3.5 font-bold text-emerald-700 dark:text-emerald-400">{{ $selectedDelivery->category_name }}</td>
