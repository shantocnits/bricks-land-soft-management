    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
        ...
        <aside class="hidden md:block md:col-span-3 sticky top-[84px] z-10 bg-white dark:bg-slate-900 border border-gray-150 dark:border-slate-800 rounded-2xl p-4 h-fit shadow-sm">
            <nav class="flex flex-col gap-1.5">
                <!-- 0. আমার প্রোফাইল -->
                <button type="button" wire:click="setTab('my_profile')"
                   class="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold transition-all border-0 {{ $activeTab === 'my_profile' ? 'bg-primary text-white shadow-md' : 'bg-transparent text-gray-700 dark:text-slate-200 hover:bg-emerald-50 dark:hover:bg-slate-800/50 hover:text-emerald-700 dark:hover:text-emerald-400' }}">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                    <span>আমার প্রোফাইল</span>
