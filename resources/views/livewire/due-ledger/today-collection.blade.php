                                ...
                                <td class="px-3 py-3.5 text-center relative" x-data="{ openDropdown: false, buttonRect: null }">
                                    ...
                                    <template x-teleport="body">
                                        <div x-show="openDropdown" @click.away="openDropdown = false" x-transition
                                            ...
                                            <a href="{{ route('challan.customer-profile', ['phone' => $col->customer_phone ?: $col->customer_name]) }}" class="w-full text-left px-3 py-2 hover:bg-primary-50 dark:hover:bg-primary-950/20 text-gray-700 dark:text-slate-200 hover:text-primary-dark dark:hover:text-primary-400 transition-all font-semibold rounded-xl cursor-pointer flex items-center gap-2">
                                            ...
                                            <button type="button" wire:click="delete({{ $col->id }})" onclick="confirm('জমা তথ্যটি মুছে ফেলবেন?') || event.stopImmediatePropagation()" @click="openDropdown = false" class="w-full text-left px-3 py-2 hover:bg-red-50 dark:hover:bg-red-950/20 text-red-500 hover:text-red-700 transition-all font-semibold rounded-xl cursor-pointer flex items-center gap-2">
